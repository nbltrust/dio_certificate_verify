...
public class SwiftCertificateVerifyPlugin: NSObject, FlutterPlugin {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "https_certificate_verify", binaryMessenger: registrar.messenger())
        let instance = SwiftCertificateVerifyPlugin()
